...
export const MainContainer = styled.main`
  ...
  @media (min-device-pixel-ratio: 2),
    ...
    background-image: url(${MobileSpinach2x}), url(${MobilePoints});
  }
  ...
  @media screen and (min-width: calc(${({ theme }) =>
    ...
    @media (min-device-pixel-ratio: 2),
      (min-resolution: 192dpi),
      (min-resolution: 2dppx) {
      background-image: url(${TabletSpinach2x}), url(${TabletPoints});
    }
  }
  ...
  @media screen and (min-width: calc(${({ theme }) =>
    ...
    @media (min-device-pixel-ratio: 2),
      (min-resolution: 192dpi),
      (min-resolution: 2dppx) {
      background-image: url(${DesctopSpinach2x}), url(${DesctopPoints});
    }
  }
`;
